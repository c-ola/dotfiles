...
_G.packer_plugins = {
  ...
  ["markdown-preview.nvim"] = {
    loaded = true,
    path = "/home/nikola/.local/share/nvim/site/pack/packer/start/markdown-preview.nvim",
