# Generated by Powerlevel10k configuration wizard on 2023-09-26 at 09:42 EDT.
...
() {
  ...
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=232 # all=232
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=43 # purple=140, green=037
  # Custom icon
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=36 # purple=135, green=36
  ...
  # When `dir` segment is on the last prompt line, ZSH_THEME="powerlevel10k/powerlevel10k"try to shorten it enough to leave at least
